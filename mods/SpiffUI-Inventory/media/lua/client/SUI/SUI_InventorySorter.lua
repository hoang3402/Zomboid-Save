...
-----
if getActivatedMods():contains("INVENTORY_TETRIS") then return nil end
...
Sorter.itemsList = function(a,b)
    ...
    local j = (a.items and a.items[1]) and clothesSort[special(a.items[1]) or a.items[1]:getBodyLocation()]
    local k = (b.items and b.items[1]) and clothesSort[special(b.items[1]) or b.items[1]:getBodyLocation()]
